...
parser = argparse.ArgumentParser(description="Football Game Simulator")
parser.add_argument("--addr", type=str, help="Kafka Host Machine Local IP Address")
args = parser.parse_args()

ip_addr = args.addr
conf = {"bootstrap.servers": f"{ip_addr}:9093, {ip_addr}:9096, {ip_addr}:9099"}
num_partitions = 3
num_replication = 3
